...
omfname varchar2(512) := NULL;
  ...
  begin
    ...
    dbms_backup_restore.restoreSetDataFile;
      ...
      dbms_backup_restore.restoreDataFileTo(3, 'C:\oraclexe\app\oracle\oradata\XE\undotbs1.dbf', 0, 'UNDOTBS1');
      dbms_backup_restore.restoreDataFileTo(2, 'C:\oraclexe\app\oracle\\oradata\XE\sysaux.dbf', 0, 'SYSAUX');
