...
CREATE TABLE `tbl_user` (
	...
	`db_type1` VARCHAR(64) NOT NULL DEFAULT 'ORACLE',
	`db_type2` VARCHAR(64) NOT NULL DEFAULT 'ORACLE',
	`db1` VARCHAR(64) NOT NULL DEFAULT 'SYSTEM a localhost:1521',
	`db2` VARCHAR(64) NOT NULL DEFAULT 'SYSTEM a localhost:1521',
	`app1` VARCHAR(64) NOT NULL DEFAULT 'notepad.exe',
	`app2` VARCHAR(64) NOT NULL DEFAULT 'mspaint.exe',
